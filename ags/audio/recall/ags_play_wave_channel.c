...
{
  static GType ags_type_play_wave_channel = 0;

  if(!ags_type_play_wave_channel){
  ...
  return(ags_type_play_wave_channel);
}
 ...
 *
 * Creates an #AgsPlayWaveChannel
 *
 * Returns: a new #AgsPlayWaveChannel
 *
 * Since: 1.5.0
 */
AgsPlayWaveChannel*
