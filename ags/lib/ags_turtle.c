...
gchar* ags_turtle_load_skip_comments_and_blanks(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
						gchar **iter);
xmlNode* ags_turtle_load_read_iriref(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				     gchar **iter);
xmlNode* ags_turtle_load_read_anon(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				   gchar **iter);
xmlNode* ags_turtle_load_read_pname_ns(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				       gchar **iter);
xmlNode* ags_turtle_load_read_pname_ln(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				       gchar **iter);
xmlNode* ags_turtle_load_read_numeric(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				      gchar **iter);
xmlNode* ags_turtle_load_read_string(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				     gchar **iter);
xmlNode* ags_turtle_load_read_langtag(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				      gchar **iter);
xmlNode* ags_turtle_load_read_literal(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				      gchar **iter);
xmlNode* ags_turtle_load_read_iri(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				  gchar **iter);
xmlNode* ags_turtle_load_read_prefix_id(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					gchar **iter);
xmlNode* ags_turtle_load_read_base(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				   gchar **iter);
xmlNode* ags_turtle_load_read_sparql_prefix(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					    gchar **iter);
xmlNode* ags_turtle_load_read_sparql_base(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					  gchar **iter);
xmlNode* ags_turtle_load_read_prefixed_name(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					    gchar **iter);
xmlNode* ags_turtle_load_read_blank_node(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					 gchar **iter);
xmlNode* ags_turtle_load_read_statement(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					gchar **iter);
xmlNode* ags_turtle_load_read_verb(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				   gchar **iter);
xmlNode* ags_turtle_load_read_predicate(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					gchar **iter);
xmlNode* ags_turtle_load_read_object(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				     gchar **iter);
xmlNode* ags_turtle_load_read_directive(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					gchar **iter);
xmlNode* ags_turtle_load_read_triple(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				     gchar **iter);
xmlNode* ags_turtle_load_read_subject(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				      gchar **iter);
xmlNode* ags_turtle_load_read_object_list(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					  gchar **iter);
xmlNode* ags_turtle_load_read_collection(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					 gchar **iter);
xmlNode* ags_turtle_load_read_blank_node_property_list(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
						       gchar **iter);
xmlNode* ags_turtle_load_read_predicate_object_list(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
						    gchar **iter);
...
xmlNode*
ags_turtle_load_read_iriref(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			    gchar **iter){
  xmlNode *node;
  ...
  look_ahead = ags_turtle_load_skip_comments_and_blanks(turtle, buffer, buffer_length,
							&look_ahead);
...
xmlNode*
ags_turtle_load_read_anon(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			  gchar **iter){
  xmlNode *node;
...
xmlNode*
ags_turtle_load_read_pname_ns(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			      gchar **iter){
  xmlNode *node;
...
xmlNode*
ags_turtle_load_read_pname_ln(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			      gchar **iter){
  xmlNode *node;
...
xmlNode*
ags_turtle_load_read_numeric(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			     gchar **iter){
  xmlNode *node;
...
xmlNode*
ags_turtle_load_read_string(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			    gchar **iter){
  xmlNode *node;
  ...
  if(str != NULL){
    node = xmlNewNode(NULL,
		      "rdf-string");
    xmlNodeSetContent(node,
		      xmlEncodeSpecialChars(turtle->doc,
					    str));
...
xmlNode*
ags_turtle_load_read_langtag(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			     gchar **iter){
  xmlNode *node;
...
xmlNode*
ags_turtle_load_read_literal(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			     gchar **iter){
  xmlNode *node;
  ...
  /* read string */
  rdf_string_node = ags_turtle_load_read_string(turtle, buffer, buffer_length,
						&look_ahead);
  ...
  if(rdf_string_node != NULL){
    ...
    *iter = look_ahead;
    ...
    rdf_langtag_node = ags_turtle_load_read_langtag(turtle, buffer, buffer_length,
						    &look_ahead);
	...
	rdf_iri_node = ags_turtle_load_read_iri(turtle, buffer, buffer_length,
						&look_ahead);
    ...
    rdf_numeric_node = ags_turtle_load_read_numeric(turtle, buffer, buffer_length,
						    &look_ahead);
...
xmlNode*
ags_turtle_load_read_iri(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			 gchar **iter){
  xmlNode *node;
  ...
  /* read iriref */
  rdf_iriref_node = ags_turtle_load_read_iriref(turtle, buffer, buffer_length,
						&look_ahead);
  ...
  if(rdf_iriref_node != NULL){
    ...
    *iter = look_ahead;
    ...
    rdf_prefixed_name_node = ags_turtle_load_read_prefixed_name(turtle, buffer, buffer_length,
								&look_ahead);
...
xmlNode*
ags_turtle_load_read_prefix_id(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			       gchar **iter){
  xmlNode *node;
  ...
  if(ags_regexec(&prefix_id_regex, look_ahead, max_matches, match_arr, 0) == 0){
    ...
    rdf_pname_ns_node = ags_turtle_load_read_pname_ns(turtle, buffer, buffer_length,
						      &look_ahead);
...
xmlNode*
ags_turtle_load_read_base(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			  gchar **iter){
  xmlNode *node;
...
xmlNode*
ags_turtle_load_read_sparql_prefix(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				   gchar **iter){
  xmlNode *node;
  xmlNode *rdf_pname_ns_node, *rdf_iriref_node;
...
xmlNode*
ags_turtle_load_read_sparql_base(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				 gchar **iter){
  xmlNode *node;
  xmlNode *rdf_iriref_node;
...
xmlNode*
ags_turtle_load_read_prefixed_name(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				   gchar **iter){
  xmlNode *node;
  ...
  rdf_pname_ln_node = ags_turtle_load_read_pname_ln(turtle, buffer, buffer_length,
						    &look_ahead);
...
xmlNode*
ags_turtle_load_read_blank_node(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				gchar **iter){
  xmlNode *node;
  ...
  if(rdf_blank_node_label != NULL){
    ...
    *iter = look_ahead;
    ...
    rdf_anon_node = ags_turtle_load_read_anon(turtle, buffer, buffer_length,
					      &look_ahead);
...
xmlNode*
ags_turtle_load_read_statement(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			       gchar **iter){
  xmlNode *node;
  ...
  rdf_directive_node = ags_turtle_load_read_directive(turtle, buffer, buffer_length,
						      &look_ahead);
  ...
  if(rdf_directive_node != NULL){
    ...
    *iter = index(look_ahead,
    ...
    rdf_triple_node = ags_turtle_load_read_triple(turtle, buffer, buffer_length,
						  &look_ahead);
...
xmlNode*
ags_turtle_load_read_verb(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			  gchar **iter){
  xmlNode *node;
  ...
  /* predicate */
  predicate_node = ags_turtle_load_read_predicate(turtle, buffer, buffer_length,
						  &look_ahead);
...
xmlNode*
ags_turtle_load_read_predicate(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			       gchar **iter){
  xmlNode *node;
  xmlNode *iri_node;
  ...
  /* iri - IRIREF */
  iri_node = ags_turtle_load_read_iri(turtle, buffer, buffer_length,
				      &look_ahead);
...
xmlNode*
ags_turtle_load_read_object(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			    gchar **iter){
  xmlNode *node;
  xmlNode *iri_node;
  xmlNode *blank_node;
  ...
  /* read blank node */
  blank_node = ags_turtle_load_read_blank_node(turtle, buffer, buffer_length,
					       &look_ahead);
  ...
  /* collection */
  if(*look_ahead == '('){
    collection_node = ags_turtle_load_read_collection(turtle, buffer, buffer_length,
						      &look_ahead);
  ...
  if(*look_ahead == '['){
    blank_node_property_list_node = ags_turtle_load_read_blank_node_property_list(turtle, buffer, buffer_length,
										  &look_ahead);
  ...
  literal_node = ags_turtle_load_read_literal(turtle, buffer, buffer_length,
					      &look_ahead);
...
xmlNode*
ags_turtle_load_read_directive(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			       gchar **iter){
  xmlNode *node;
  ...
  rdf_prefix_id_node = ags_turtle_load_read_prefix_id(turtle, buffer, buffer_length,
						      &look_ahead);
  ...
  rdf_base_node = ags_turtle_load_read_base(turtle, buffer, buffer_length,
					    &look_ahead);
  ...
  rdf_sparql_prefix_node = ags_turtle_load_read_sparql_prefix(turtle, buffer, buffer_length,
							      &look_ahead);
  ...
  rdf_sparql_base_node = ags_turtle_load_read_sparql_base(turtle, buffer, buffer_length,
							  &look_ahead);
...
xmlNode*
ags_turtle_load_read_triple(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			    gchar **iter){
  xmlNode *node;
  ...
  /* subject */
  subject_node = ags_turtle_load_read_subject(turtle, buffer, buffer_length,
					      &look_ahead);

  /* create triple node */
  if(subject_node != NULL){
    /* first predicate object list */
    predicate_object_list_node_0 = ags_turtle_load_read_predicate_object_list(turtle, buffer, buffer_length,
									      &look_ahead);
    ...
    if(predicate_object_list_node_0 != NULL){
      ...
      predicate_object_list_node_1 = ags_turtle_load_read_predicate_object_list(turtle, buffer, buffer_length,
										&look_ahead);
	...
	xmlAddChild(node,
      ...
      *iter = look_ahead;
      ...
      blank_node_object_list_node = ags_turtle_load_read_blank_node_property_list(turtle, buffer, buffer_length,
										  &look_ahead);
...
xmlNode*
ags_turtle_load_read_subject(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
			     gchar **iter){
  xmlNode *node;
  xmlNode *iri_node;
  xmlNode *blank_node;
...
xmlNode*
ags_turtle_load_read_object_list(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				 gchar **iter)
{
  xmlNode *node;
  xmlNode *object_node;
  ...
  /* read first object */
  object_node = ags_turtle_load_read_object(turtle, buffer, buffer_length,
					    &look_ahead);
...
xmlNode*
ags_turtle_load_read_collection(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
				gchar **iter)
{
  xmlNode *node;
  xmlNode *object_node;
  ...
  if(*look_ahead == '('){
    ...
    /* read objects */
    while((object_node = ags_turtle_load_read_object(turtle, buffer, buffer_length,
						     &look_ahead)) != NULL){
#ifdef AGS_DEBUG
...
xmlNode*
ags_turtle_load_read_predicate_object_list(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					   gchar **iter)
{
  xmlNode *node;
  ...
  current_verb_node = ags_turtle_load_read_verb(turtle, buffer, buffer_length,
						&look_ahead);

  if(current_verb_node != NULL){
    current_object_list_node = ags_turtle_load_read_object_list(turtle, buffer, buffer_length,
								&look_ahead);
...
xmlNode*
ags_turtle_load_read_blank_node_property_list(AgsTurtle *turtle, gchar *buffer, guint buffer_length,
					      gchar **iter)
{
  xmlNode *node;
  ...
  if(*look_ahead == '['){
    ...
    predicate_object_list_node = ags_turtle_load_read_predicate_object_list(turtle, buffer, buffer_length,
									    &look_ahead);
		...
		GError **error)
{
  ...
  do{
    /* skip blanks and comments */
    iter = ags_turtle_load_skip_comments_and_blanks(turtle, buffer, sb->st_size,
						    &iter);
    ...
    rdf_statement_node = ags_turtle_load_read_statement(turtle, buffer, sb->st_size,
							&iter);
